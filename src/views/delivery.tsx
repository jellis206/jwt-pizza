...
import type { JWTPayload, Order, OrderItem } from '../service/pizzaService';
...
export default function Delivery() {
  ...
  async function verify() {
    try {
      ...
      setJwtPayload({ message: err.message, payload: { error: 'invalid JWT. Looks like you have a bad pizza!' } as unknown as string });
    }
